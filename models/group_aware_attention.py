...
class Attention(nn.Cell):
    def __init__(self, dim, linear_dim, num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        self.bn = nn.BatchNorm1d(60, eps=1e-05, momentum=0.1, affine=True, use_batch_statistics=True)
...
if __name__ == '__main__':
    ...
    v1 = ms.Tensor(shape=(1, 60, 1024), dtype=ms.float32, init=Normal())
    q1 = ms.Tensor(shape=(1, 60, 1024), dtype=ms.float32, init=Normal())
    k1 = q1
    feature_1_tmp = attn_encoder(q1, k1, v1)  # B,60,1024
    print(f'feature_1_tmp.shape: {feature_1_tmp.shape}')
